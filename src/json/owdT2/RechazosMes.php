...
CASE
    WHEN s.respuestas = '0 - 50' THEN 1
    WHEN s.respuestas = '50 - 200' THEN 1
    WHEN s.respuestas = '200 a Mas' THEN 1
    WHEN s.respuestas = 'Dinero' THEN 1
    WHEN s.respuestas = 'Envases' THEN 1
    WHEN s.respuestas = 'Otros' THEN 1
...
WHERE id_tema=496465588
AND id_grupo_preguntas <> 72 AND respuesta_user <> '' 
$WhereAnd 
) AS s  
) AS b 
GROUP BY  
