...
SUM(b.contador) as contador,
        CASE
        WHEN b.id_preguntas = 'x' THEN ((SUM(b.respuesta_valor) / SUM(b.contador))-1)*-1
...
WHERE id_tema=521229025
AND `fecha_registro`>='2021-01-01' AND `fecha_registro` <= '2021-12-31' /* AND  grupo = '6083868d58c43' */ 
AND id_grupo_preguntas <> 50 AND respuesta_user <> '' 
$WhereAnd 
) AS s 
) AS b 
GROUP BY  
