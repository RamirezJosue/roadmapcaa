...
CASE
    ...
    WHEN s.respuestas = 'Reparto' THEN 1
    WHEN s.respuestas = 'Auxiliar' THEN 1
    WHEN s.respuestas = 'Conductor' THEN 1
    WHEN s.respuestas = 'No uso 3 puntos de apoyo' THEN 0
    WHEN s.respuestas = 'No utilizaron cinturón de seguridad' THEN 0
    WHEN s.respuestas = 'No pusieron Tacos' THEN 0
    WHEN s.respuestas = 'No pusieron conos' THEN 0
    WHEN s.respuestas = 'No se retiraron las llaves al estacionar' THEN 0
    WHEN s.respuestas = 'No realizaron vuelta 360°' THEN 0
    WHEN s.respuestas = 'No cometieron ninguna acto inseguro' THEN 1
    WHEN s.respuestas = 'No aplica' THEN 1
    WHEN s.respuestas = 'No se tenia programado' THEN 1
    ELSE 0
...
WHERE id_tema=532843891
AND id_grupo_preguntas <> 44 AND respuesta_user <> '' 
$WhereAnd 
) AS s  
) AS b 
GROUP BY  
